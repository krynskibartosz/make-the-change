import { AlertTriangle, Camera, CheckSquare, Euro, Hammer, Package } from 'lucide-react'
...
export default function AjouterMenuPage() {
  return (
    <Screen title="Que veux-tu ajouter ?" backHref="/planning" eyebrow="Nouveau">
      <div className="grid gap-3 mt-4">
        {ADD_ACTIONS.map((action) => (
          ...
          >
            <div
              className={`flex size-12 shrink-0 items-center justify-center rounded-xl bg-background shadow-sm ${action.color}`}
            >
