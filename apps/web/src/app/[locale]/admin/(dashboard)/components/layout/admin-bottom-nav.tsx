...
type AdminNavItem = {
  id: 'dashboard' | 'orders' | 'products' | 'projects' | 'partners' | 'users'
  href: string
  icon: LucideIcon
  label: string
}
...
const navItems: AdminNavItem[] = [
  ...
  { id: 'orders', href: '/admin/orders', icon: ShoppingCart, label: 'Commandes' },
  { id: 'products', href: '/admin/products', icon: Package, label: 'Produits' },
  { id: 'projects', href: '/admin/projects', icon: Sprout, label: 'Projets' },
  { id: 'partners', href: '/admin/partners', icon: Handshake, label: 'Partenaires' },
