...
export const ProductEditHeader: FC<ProductEditHeaderProps> = ({ autoSave, hasUnsavedChanges }) => {
  ...
  return (
    <AdminDetailHeader
      ...
      productImage={
        currentData?.images && currentData.images.length > 0 ? currentData.images[0] : undefined
      }
