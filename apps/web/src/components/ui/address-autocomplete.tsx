      ...
      {!selectedAddress && (
        <div className="relative">
          ...
          {showDropdown && suggestions.length > 0 && !error && (
            <div className="absolute z-[1000] mt-1 w-full overflow-hidden rounded-xl border border-white/10 bg-black/80 shadow-xl backdrop-blur-md">
                ...
                {suggestions.map((result) => (
                  <li key={result.place_id}>
                    <button
                      ...
                      className="flex w-full items-start gap-3 px-4 py-2.5 text-left text-sm text-white transition-colors hover:bg-white/10 cursor-pointer"
                    >
