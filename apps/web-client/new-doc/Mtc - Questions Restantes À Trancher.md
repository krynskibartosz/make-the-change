...
SRL Make the Change en V1

ASBL

Plus tard si dons purs importants

PSP

Stripe Connect cible, Mollie test possible

Don pur

Frais transparents, pas marge cachée

Soutien producteur

Commission 10–15 %, proposition 12 %
...
Carte / QR code co-brandé

Credits Impact

1 € soutien = 1 CI, sans valeur cash
...
Minimum viable dès la V1

Reçu fiscal

Non, sauf validation légale

Nouvelles terrain

Timeline + badge + niveaux de preuve
