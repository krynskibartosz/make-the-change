...
const SUBDOMAINS = [
  {
    ...
    textureOpacity: 0.78, tintOpacity: 0.26, darken: 0.16,
    icon: 'flower',
    iconXY: [115, 88],
    labelXY: [115, 145],
    progXY:  [115, 180],
    labelRX: 70, labelRY: 30,
  ...
  },
  {
    ...
    textureOpacity: 0.72, tintOpacity: 0.30, darken: 0.22,
    icon: 'leaves',
    iconXY: [265, 88],
    labelXY: [265, 145],
    progXY:  [265, 180],
  ...
  },
  {
    ...
    color: '#9b6dd4',
    dark: '#1a0e2a',
    texture: 'assets/atlas_bg.png',
    textureOpacity: 0.55, tintOpacity: 0.55, darken: 0.22,
    icon: 'wave',
    iconXY: [300, 248],
    labelXY: [300, 292],
    progXY:  [300, 322],
    labelRX: 60, labelRY: 30,
  ...
  },
  {
    ...
    textureOpacity: 0.85, tintOpacity: 0.20, darken: 0.14,
    icon: 'mushroom',
    iconXY: [256, 402],
    labelXY: [256, 452],
    progXY:  [256, 486],
  ...
  },
  {
    ...
    textureOpacity: 0.62, tintOpacity: 0.34, darken: 0.22,
    icon: 'heart',
    iconXY: [124, 402],
    labelXY: [124, 452],
    progXY:  [124, 486],
  ...
  },
  {
    ...
    textureOpacity: 0.82, tintOpacity: 0.28, darken: 0.14,
    icon: 'swords',
    iconXY: [80, 248],
    labelXY: [80, 292],
    progXY:  [80, 322],
    labelRX: 58, labelRY: 30,
  ...
  },
  {
    ...
    textureOpacity: 0.78, tintOpacity: 0.22, darken: 0.24,
    central: true,
    icon: 'link',
    iconXY: [190, 226],
    labelXY: [190, 278],
...
function buildL2Edges(segments = 7, amplitude = 7) {
  ...
  for (const c of SUBDOMAINS) {
    ...
    for (let i = 0; i < vs.length; i++) {
      ...
      const p0 = L2_VERTICES[lo], p1 = L2_VERTICES[hi];
...
function SubdomainCarte({ onPick, glow = 1, animate = true }) {
  ...
  return (
    <svg viewBox="0 0 380 570" width="100%" height="100%" preserveAspectRatio="xMidYMid meet" style={{ display:'block', isolation:'isolate' }}>
      <defs>
        {SUBDOMAINS.map(c => (
          <clipPath key={c.id} id={`l2-clip-${c.id}`}><path d={cellPaths[c.id]}/></clipPath>
        ))}
        {SUBDOMAINS.map(c => (
        ...
        return (
          <g key={c.id}
            ...
            <g clipPath={`url(#l2-clip-${c.id})`} style={{ isolation:'isolate' }}>
              ...
              <ellipse cx={c.labelXY[0]} cy={(c.iconXY[1] + c.progXY[1]) / 2}
                  rx={c.labelRX * 1.05}
            ...
            {/* edge glow */}
            <path d={d} fill="none" stroke={c.color} strokeOpacity="0.85" strokeWidth="1.1" filter="url(#l2CellGlow)"/>
            ...
            <g style={{ pointerEvents:'none' }}>
              ...
              <circle cx={ix} cy={iy} r="18" fill="rgba(8,10,12,0.82)" stroke={c.color} strokeOpacity="0.78" strokeWidth="1"/>
              ...
              <text x={lx} y={ly} textAnchor="middle"
                    ...
                    fontSize={c.central ? 13 : 13.5} fontWeight="600" letterSpacing="0.1"
                    style={{ paintOrder:'stroke', stroke:'rgba(0,0,0,0.92)', strokeWidth:'3.4px', strokeLinejoin:'round' }}>
                {c.name}
              </text>
              {c.name2 && (
                <text x={c.label2XY[0]} y={c.label2XY[1]} textAnchor="middle"
                      fill="#f6efdc" fontFamily="Inter, system-ui, sans-serif"
              ...
              <g>
                <rect x={px - 24} y={py - 11} width="48" height="21" rx="10.5"
                    fill="rgba(8,10,12,0.82)"
                    stroke={c.color} strokeOpacity="0.55" strokeWidth="0.8"/>
                <text x={px} y={py + 3.5} textAnchor="middle"
                    fill="#eae3d2" fontFamily="Inter, system-ui, sans-serif"
      ...
      {L2_JUNCTIONS.map((k, i) => {
        ...
        return (
          <g key={k} style={{ pointerEvents:'none' }}>
            <circle cx={p[0]} cy={p[1]} r={9 * glow} fill="#f4d889" opacity="0.30" filter="url(#l2NodeGlow)"/>
            <circle cx={p[0]} cy={p[1]} r={5 * glow} fill="#f4d889" opacity="0.5" filter="url(#l2NodeGlow)"/>
            <circle cx={p[0]} cy={p[1]} r="1.6" fill="#fff5d8" opacity="0.92"/>
            {animate && (
              <circle cx={p[0]} cy={p[1]} r="1.6" fill="#fff5d8">
                <animate attributeName="r" values="1.6;3.2;1.6" dur={`${3 + (i * 0.4)}s`} repeatCount="indefinite"/>
...
// ── Full screen ──────────────────────────────────────────────
function Level2Screen({ onBack, onPickSubdomain }) {
  return (
    <div style={{ position:'relative', width:'100%', height:'100%', overflow:'hidden', background:'#04060a' }}>
      <AtlasBackground dust={0.20} vignette={0.55}/>
      ...
      <div style={{
          ...
          <div style={{ display:'flex', alignItems:'flex-start', gap:10 }}>
            ...
            <div style={{ flex:1, textAlign:'center', minWidth:0, padding:'0 4px 0' }}>
              <div style={{
                ...
                color:'#e6ad44', fontWeight:500,
              }}>Relations du vivant</div>
              <h1 style={{
                margin:'1px 0 0',
                fontFamily:"'Cormorant Garamond', serif", fontWeight:500,
                fontSize:26, lineHeight:1.05, color:'#f6efdc',
                letterSpacing:'-0.3px',
              ...
              <div style={{
                ...
                color:'#b9b09a',
              }}>Explore les liens qui unissent les espèces entre elles.</div>
            </div>
        ...
        <div style={{
          ...
          <div style={{
            aspectRatio:'380 / 570',
            width:'100%', maxWidth:412, maxHeight:'100%',
            display:'flex',
          }}>
...
Object.assign(window, { Level2Screen, SUBDOMAINS });
