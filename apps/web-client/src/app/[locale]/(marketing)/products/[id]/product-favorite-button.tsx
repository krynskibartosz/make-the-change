    ...
    return (
        <Button
            ...
            className={cn(
                ...
                isFavorite && 'border-marketing-positive-500/20 bg-marketing-positive-50 text-marketing-positive-500 hover:bg-marketing-positive-100 hover:text-marketing-positive-600',
                className
            )}
