...
export const INVEST_FLOW_MODAL_CONTENT_CLASSNAME = `${MODAL_SURFACE_BASE_CLASSNAME} data-[open]:animate-none data-[closed]:animate-none sm:h-[calc(100dvh-2rem)] sm:max-h-[calc(100dvh-2rem)] sm:max-w-3xl`
