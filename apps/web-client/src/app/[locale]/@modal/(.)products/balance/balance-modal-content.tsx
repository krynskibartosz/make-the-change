...
function ImpactHistoryList({ transactions }: { transactions: MockPointsTransactionRecord[] }) {
  return (
...
function WarriorState({ balance, transactions }: { balance: number; transactions: MockPointsTransactionRecord[] }) {
  return (
