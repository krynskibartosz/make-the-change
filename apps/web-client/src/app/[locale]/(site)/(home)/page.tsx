...
import { HomeEcosystemSection } from '@/app/[locale]/(site)/(home)/_components/sections/home-ecosystem-section'
import { HomeFaqSection } from '@/app/[locale]/(site)/(home)/_components/sections/home-faq-section'
import { HomeFinalCtaSection } from '@/app/[locale]/(site)/(home)/_components/sections/home-final-cta-section'
import { HomeFeaturedProductsSection } from '@/app/[locale]/(site)/(home)/_components/sections/home-featured-products-section'
import { HomeFeaturedProjectsSection } from '@/app/[locale]/(site)/(home)/_components/sections/home-featured-projects-section'
import { HomeGamificationSection } from '@/app/[locale]/(site)/(home)/_components/sections/home-gamification-section'
import { HomeHeroContent } from '@/app/[locale]/(site)/(home)/_components/layout/home-hero-content'
import { HomeReveal } from '@/app/[locale]/(site)/(home)/_components/layout/home-reveal'
import { MarketingStepsSection } from '@/app/[locale]/(site)/(home)/_components/sections/marketing-steps-section'
import { Logo } from '@/components/ui/logo'
import { Link } from '@/i18n/navigation'
import { getPublicAppUrl } from '@/lib/public-url'
import { getLocalizedContent } from '@/lib/utils'
import { getHomeServerData } from './_api/home.server-data'
import { HeroParallaxBackground } from './_components/layout/hero-parallax-background'
