...
type MarketingCtaBandProps = MarketingCtaBandRootProps & {
  ...
  footerProps?: MarketingCtaBandFooterProps
}
...
} satisfies Record<MarketingCtaBandTone, string>
...
export const MarketingCtaBand = ({
  ...
  >
    ...
    <div
      className="absolute -top-[40%] -right-[20%] h-[80%] w-[80%] rounded-full bg-primary/20 blur-[120px] mix-blend-screen animate-pulse duration-4000"
      aria-hidden="true"
    />
    <div
      className="absolute -bottom-[40%] -left-[20%] h-[80%] w-[80%] rounded-full bg-secondary/20 blur-[120px] mix-blend-screen animate-pulse duration-6000"
      aria-hidden="true"
    />

    <div
      className="absolute inset-0 opacity-10 mix-blend-overlay pointer-events-none bg-[url('data:image/svg+xml;base64,')] mask-[radial-gradient(ellipse_at_center,black_40%,transparent_70%)]"
      aria-hidden="true"
    />
    ...
    <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center text-center">
      ...
      {footer ? (
        <footer {...footerProps} className={cn('pt-12', footerProps?.className)}>
          {footer}
        </footer>
      ) : null}
    </div>
