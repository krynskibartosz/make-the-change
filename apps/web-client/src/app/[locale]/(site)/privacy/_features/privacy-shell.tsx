...
type PrivacyShellProps = PropsWithChildren<{
  title?: string
}>

export function PrivacyShell({ title = 'Confidentialité', children }: PrivacyShellProps) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex h-[100dvh] w-full flex-col overflow-x-hidden overflow-y-auto overscroll-y-contain bg-[#0B0F15] pb-12 text-white">
      {/* Header fixed glass - identique à contact */}
