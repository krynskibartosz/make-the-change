...
function enrichProducerWithEditorialData(producer: MockProducerSeed): MockProducerSeed {
  ...
  if (
    producer.slug === 'ilanga-nature' ||
    producer.name_default?.toLowerCase().includes('ilanga')
  ) {
    return {
      ...producer,
      ...
      missionPillars: [
        {
          ...
          description:
            'Ilanga accompagne des apiculteurs partenaires à Madagascar en combinant formation terrain, fourniture de ruches et approvisionnement équitable.',
          keyPoints: [
          ...
          whyItMatters:
            "Un meilleur accompagnement aide à structurer une filière locale plus durable. Ces actions s'inscrivent dans une logique de soutien documenté, sans constituer une preuve d'impact mesuré.",
        ...
        },
        {
          ...
          description:
            "Ilanga sélectionne et valorise des produits artisanaux malgaches à l'international : miels, vanilles, épices et confitures issus de petits producteurs locaux.",
          keyPoints: [
          ...
          whyItMatters:
            "Valoriser ces filières localement aide à créer des débouchés économiques pour les producteurs. Cela reste une démarche de mise en marché éthique, pas une mesure d'impact écologique.",
          sourceLabel: 'Information partenaire documentée',
        },
        {
          icon: 'BadgeCheck',
          ...
          description:
            "Chaque production est suivie et certifiée biologiquement par Ecocert. L'humidité des miels est contrôlée entre 16 et 18% à chaque récolte.",
          keyPoints: [
          ...
          whyItMatters:
            "La certification et le suivi de qualité garantissent la cohérence du produit. Il s'agit d'une démarche de critères documentés, pas d'une garantie d'impact environnemental mesuré.",
          sourceLabel: 'Information partenaire documentée',
        },
      ],
      ...
      impactSummary: {
        ...
        disclaimer:
          'Estimation pédagogique basée sur les hypothèses de financement des projets, pas une mesure terrain.',
      },
      ...
      partnerCatalogOverview: {
        ...
        disclaimer:
          "Ilanga Nature valorise plusieurs filières. Seule une partie de ces produits est disponible dans l'app.",
        families: [
          {
  ...
  // ── Habeebee enrichment ──
  if (
    producer.slug === 'habeebee-belgique' ||
    producer.name_default?.toLowerCase().includes('habeebee')
  ) {
    return {
      ...producer,
      ...
      editorialIdentity: {
        ...
        tagline: "De la ruche à l'atelier, des soins naturels fabriqués à Bruxelles.",
        summary:
          "Habeebee est une savonnerie artisanale et un projet d'apiculture fondés en 2016 par Alexia à Bruxelles. L'entreprise fabrique à la main des savons solides et des cosmétiques bio utilisant de la cire d'abeille et de la propolis, avec une approche de saponification à froid. En 2024, Léonard et Quentin ont rejoint l'aventure comme associés pour développer le potentiel de la marque.",
        emotionalStatement:
          'Valoriser les matières de la ruche, fabriquer localement et transmettre une apiculture familiale.',
        missionIntro:
          'Valoriser les matières de la ruche, fabriquer localement et transmettre une apiculture familiale.',
      },
      visualAssets: {
      ...
      missionPillars: [
        {
          ...
          shortDescription:
            'Fabrication 100% à la main, saponification à froid, production locale en Belgique.',
          description:
            'Habeebee fabrique ses savons à la main dans sa savonnerie à Bruxelles, en utilisant la méthode de saponification à froid. La production est locale et artisanale, avec une équipe dédiée qui produit chaque jour des soins pour la peau.',
          keyPoints: [
          ...
          whyItMatters:
            "Une production artisanale locale permet de maîtriser les processus de fabrication et de réduire l'empreinte transport. Ces pratiques documentées s'inscrivent dans une logique de production locale, sans constituer une preuve d'impact mesuré.",
          sourceLabel: 'Information partenaire documentée',
        },
        {
          icon: 'Hexagon',
          ...
          shortDescription:
            'Formation apiculture familiale, collecte de cire et propolis, récolte à vélo.',
          description:
            "Habeebee propose des packs et formations pour apprendre l'apiculture familiale et naturelle à Bruxelles. Le programme inclut la collecte de cire et de propolis, avec un cycle de récolte à vélo pour minimiser l'impact transport.",
          keyPoints: [
          ...
          whyItMatters:
            "L'apiculture familiale et naturelle vise à sensibiliser au monde des abeilles et à développer des pratiques de proximité. Ces actions documentées s'inscrivent dans une logique de transmission, sans constituer une preuve d'impact mesuré.",
          sourceLabel: 'Information partenaire documentée',
        },
        {
          icon: 'HeartHandshake',
          ...
          shortDescription:
            'Soutien scouts, associations non lucratives, partenariat réinsertion sociale.',
          description:
            "Habeebee soutient des initiatives locales à travers des partenariats solidaires. Le savon 'Scout Toujours' est proposé à prix exclusif pour les scouts, le savon 'Qui a Bon Fond' pour les associations non lucratives, et l'entreprise collabore avec des structures de réinsertion sociale.",
          keyPoints: [
          ...
          whyItMatters:
            "Soutenir des initiatives locales et des structures d'insertion permet de renforcer le tissu social local. Ces partenariats documentés s'inscrivent dans une logique de solidarité, sans constituer une preuve d'impact mesuré.",
          sourceLabel: 'Information partenaire documentée',
        },
      ],
      proofCards: [
        {
          label: 'Certification ECOGARANTIE',
          value: 'Control Certisys',
          icon: 'BadgeCheck',
          proofType: 'certification',
        },
        {
          label: 'Collecte locale à vélo',
          value: 'Récolte de cire & propolis',
          icon: 'Bike',
          proofType: 'field_operation',
        },
        { label: 'Saponification à froid', icon: 'FlaskConical', proofType: 'method' },
        {
          label: 'Atelier à Bruxelles',
          value: 'Watermael-Boitsfort',
          icon: 'MapPin',
          proofType: 'location',
        },
        ...
        {
          label: 'Cire & propolis',
          value: 'Ingrédients de la ruche',
          icon: 'Leaf',
          proofType: 'method',
        },
        {
          label: 'Apiculture familiale',
          value: 'Programme HabeebeeCulture',
          icon: 'Hexagon',
          proofType: 'method',
        },
        {
          label: 'Soutien scouts & associations',
          value: 'Scout Toujours • Qui a Bon Fond',
          icon: 'Users',
          proofType: 'partner',
        },
  ...
  if (
    producer.slug === 'trilogy-ocean-restoration' ||
    producer.name_default?.toLowerCase().includes('trilogy')
  ) {
    return {
      ...producer,
      ...
      editorialIdentity: {
        ...
        tagline: 'Restauration corallienne & éducation marine',
        summary:
          'Trilogy Ocean Restoration est une organisation indonésienne fondée en 2024, basée à Karimunjawa, Java central. Elle se concentre sur la réparation et la restauration des récifs coralliens, mangroves et herbiers marins. En partenariat avec Karimunjawa Scuba Diving, Scuba School International et Seacrest Indonesia, Trilogy propose des programmes de formation, des excursions éducatives et des actions de propagation corallienne documentées sur le terrain.',
        emotionalStatement:
          'À Karimunjawa, Trilogy replante des fragments de corail, suit les récifs et transmet les savoirs marins.',
        missionIntro:
          'Restaurer les récifs, transmettre les savoirs marins et impliquer les visiteurs dans la protection des coraux.',
      ...
      visualAssets: {
        ...
        story: [
          {
            id: 'story-1',
            url: TRILOGY_PATHS.media.story1CoralDiver,
            role: 'story' as const,
            type: 'field_photo' as const,
            alt: 'Plongeur sur le récif de Karimunjawa',
            sourceUrl: 'https://www.tiktok.com/@trilogyoceanrestoration',
          },
          {
            id: 'story-2',
            url: TRILOGY_PATHS.media.youtube9CilikIsland,
            role: 'field_proof' as const,
            type: 'field_photo' as const,
            alt: 'Coral Restoration at Cilik Island',
            sourceUrl: 'https://www.youtube.com/@TrilogyOceanRestoration',
          },
          {
            id: 'story-3',
            url: TRILOGY_PATHS.media.youtube7Monitoring,
            role: 'field_proof' as const,
            type: 'field_photo' as const,
            alt: 'Effective monitoring for coral restoration',
            sourceUrl: 'https://www.youtube.com/@TrilogyOceanRestoration',
          },
          {
            id: 'story-4',
            url: TRILOGY_PATHS.media.story12DiveEdutrip,
            role: 'story' as const,
            type: 'field_photo' as const,
            alt: 'Dive Edutrip Karimunjawa',
            sourceUrl: 'https://www.tiktok.com/@trilogyoceanrestoration',
          },
          {
            id: 'story-5',
            url: TRILOGY_PATHS.media.youtube8PlantingCoral,
            role: 'field_proof' as const,
            type: 'field_photo' as const,
            alt: 'Planting coral fragments',
            sourceUrl: 'https://www.youtube.com/@TrilogyOceanRestoration',
          },
          {
            id: 'story-6',
            url: TRILOGY_PATHS.media.story9ExploreBiodiversity,
            role: 'story' as const,
            type: 'field_photo' as const,
            alt: 'Exploration biodiversité Karimunjawa',
            sourceUrl: 'https://www.tiktok.com/@trilogyoceanrestoration',
          },
        ],
      },
      missionPillars: [
        {
          ...
          shortDescription:
            'Plantation de fragments de corail et suivi des jardins sous-marins à Cilik Island.',
          description:
            'Trilogy Ocean Restoration implante de nouveaux fragments de corail pour recréer des zones de biodiversité marine active, documentant les sites comme Cilik Island. Chaque intervention est suivie pour mesurer la survie et la croissance des nouvelles colonies.',
          keyPoints: [
          ...
          whyItMatters:
            "Les coraux sont les fondements des écosystèmes tropicaux, fournissant un habitat essentiel à des milliers d'espèces marines. Ces actions de restauration sont documentées qualitativement via vidéos terrain, sans métriques d'impact quantifiées par le partenaire.",
          sourceLabel:
            'Information partenaire documentée — TikTok & YouTube @TrilogyOceanRestoration',
        },
        {
          icon: 'GraduationCap',
          ...
          shortDescription:
            "Formation de moniteurs certifiés SSI et excursions d'exploration de la biodiversité marine.",
          description:
            'Trilogy propose des cours de formation de moniteurs de plongée certifiés Scuba School International (SSI), des Dive Edutrips et des programmes de sensibilisation à la biodiversité marine de Karimunjawa.',
          keyPoints: [
          ...
          whyItMatters:
            "Former des moniteurs locaux crée une capacité durable de transmission des savoirs. La certification SSI est un signal de compétence, pas une preuve directe d'impact écologique.",
        ...
        },
        {
          ...
          shortDescription:
            'Programme permettant aux individus de soutenir la restauration corallienne.',
          description:
            "Trilogy propose un programme d'adoption de coraux permettant à des individus et organisations de soutenir concrètement les efforts de restauration. Ce mécanisme d'engagement communautaire contribue à la durabilité financière du projet.",
          keyPoints: [
          ...
          whyItMatters:
            "Ce programme crée un lien direct entre soutien financier et action terrain documentée. C'est un mécanisme d'engagement, pas une garantie de résultat mesuré.",
          sourceLabel: 'Information partenaire documentée — Peek Holidays & réseaux sociaux',
        },
      ],
      proofCards: [
        {
          label: 'Site de restauration',
          value: 'Cilik Island, Karimunjawa',
          icon: 'Waves',
          proofType: 'field_operation',
        },
        {
          label: "Programme d'adoption de coraux",
          value: 'Coral Adoption Program',
          icon: 'HandHeart',
          proofType: 'method',
        },
        {
          label: 'Suivi des coraux',
          value: 'Monitoring de croissance',
          icon: 'Camera',
          proofType: 'method',
        },
        {
          label: 'Localisation documentée',
          value: 'Karimunjawa, Java central',
          icon: 'MapPin',
          proofType: 'location',
        },
        {
          label: 'Partenariat conservation',
          value: 'Seacrest Indonesia',
          icon: 'Handshake',
          proofType: 'partner',
        },
        {
          label: 'Formation certifiée SSI',
          value: 'Scuba Schools International',
          icon: 'Award',
          proofType: 'partner',
        },
        {
          label: 'Partenariat plongée',
          value: 'Karimunjawa Scuba Diving',
          icon: 'Users',
          proofType: 'partner',
        },
        {
          label: 'Formation moniteurs',
          value: 'Instructor Training Course',
          icon: 'GraduationCap',
          proofType: 'method',
        },
        {
          label: 'Biodiversité marine documentée',
          value: 'Exploration Karimunjawa',
          icon: 'Fish',
          proofType: 'field_operation',
        },
        {
