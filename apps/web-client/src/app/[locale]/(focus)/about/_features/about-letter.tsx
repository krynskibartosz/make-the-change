...
export function AboutLetter({ body, signature }: AboutLetterProps) {
  return (
    <section className="mx-auto flex max-w-lg flex-col items-center justify-center px-10 py-24 text-center">
      <p className="mb-12 text-lg font-light leading-[2] text-gray-400">
      ...
      <div className="flex items-center justify-center gap-4 text-[10px] font-medium uppercase tracking-[0.2em] text-gray-500">
        <span className="h-[1px] w-12 bg-gradient-to-r from-transparent to-gray-600" />
        {signature}
        <span className="h-[1px] w-12 bg-gradient-to-l from-transparent to-gray-600" />
      </div>
    </section>
  )
}
