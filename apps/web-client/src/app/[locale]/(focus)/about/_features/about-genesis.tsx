...
export function AboutGenesis({ title, paragraph1, paragraph2 }: AboutGenesisProps) {
  return (
    <section className="mx-auto max-w-xl px-8 py-24 flex flex-col items-start">
      ...
      {/* Title */}
      <h2 className="mb-10 text-left text-3xl font-bold text-white tracking-tight leading-tight sm:text-4xl">{title}</h2>
      ...
      <div className="relative flex flex-col gap-5 pl-6">
        ...
        {/* Paragraph 1 */}
        <p className="text-base font-light leading-[1.8] text-gray-400">
          {paragraph1}
        </p>
        ...
        <p className="text-base font-light leading-[1.8] text-gray-400">
          ...
          <span className="font-medium text-gray-100 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]">jeu</span>, la{' '}
          <span className="font-medium text-gray-100 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]">technologie</span> et la{' '}
          <span className="font-medium text-gray-100 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]">transparence</span>.
        </p>
      </div>
    </section>
  )
