  ...
  return (
    <div className="min-h-screen bg-[#0B0F15] text-white flex flex-col relative pb-10 overflow-hidden">
      ...
      <div className="relative z-10 px-6 pb-10 grid grid-cols-2 gap-3">
        ...
        <a
          href="/faq"
          className="col-span-1 p-5 rounded-2xl bg-[#1A1F26] border border-white/5 shadow-sm flex flex-col justify-between aspect-square group cursor-pointer hover:border-white/10 transition"
        >
        ...
        <div className="col-span-1 p-5 rounded-2xl bg-[#1A1F26] border border-white/5 shadow-sm flex flex-col justify-between aspect-square">
      ...
      <div className="relative z-10 px-6 mb-20 flex flex-col gap-6">
            ...
            {(
              ...
              return (
                <button
                  ...
                  className={
                    isActive
                      ? 'px-4 py-2 rounded-full border border-lime-400/20 bg-lime-400/10 text-sm text-lime-400 font-bold transition'
                      : 'px-4 py-2 rounded-full border border-white/10 bg-white/5 text-sm text-white/50 hover:text-white hover:border-white/20 transition'
                  }
                >
                  {chip.label}
                </button>
        ...
        <button
          type="submit"
          className="w-full bg-lime-400 text-[#0B0F15] font-black text-lg h-14 rounded-2xl active:scale-[0.98] transition-all shadow-[0_0_30px_rgba(132,204,22,0.15)] flex items-center justify-center mt-8"
        >
          Envoyer le message
        </button>
      </div>
