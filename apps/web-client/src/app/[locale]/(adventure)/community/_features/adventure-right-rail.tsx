...
import { AdventureLeaderboardCard } from './adventure-leaderboard-card'

type AdventureRightRailVariant = 'default' | 'guilds' | 'guild_detail'

type AdventureRightRailProps = {
  variant?: AdventureRightRailVariant
...
export async function AdventureRightRail({
  variant = 'default',
