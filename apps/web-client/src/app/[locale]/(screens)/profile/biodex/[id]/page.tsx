...
import { OriginWidget } from '@/app/[locale]/(screens)/profile/biodex/_components/bento-origin'
import { DietWidget } from '@/app/[locale]/(screens)/profile/biodex/_components/bento-diet'
import { IUCNWidget } from '@/app/[locale]/(screens)/profile/biodex/_components/bento-iucn'
import { HabitatCarousel } from '@/app/[locale]/(screens)/profile/biodex/_components/habitat-carousel'
import { ThreatTags } from '@/app/[locale]/(screens)/profile/biodex/_components/threat-tags'
import { EvolutionCard } from '@/app/[locale]/(screens)/profile/biodex/_components/evolution-card'
