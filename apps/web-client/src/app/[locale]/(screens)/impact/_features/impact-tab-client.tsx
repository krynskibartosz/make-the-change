...
const MOCK_IMPACT_FEED: ImpactEvent[] = [
  {
    ...
    time: 'Il y a 2 min',
    action: 'A apporté sa contribution au Rucher de Manakara pour Sylva.',
    icon: Sprout,
  ...
  },
  {
    ...
    time: 'Il y a 14 min',
    action: 'A complété une mission et fait progresser la récolte de Melli.',
    icon: Trophy,
  ...
  },
  {
    ...
    action: 'A ajouté 120 points de progression au réservoir commun pour Aura.',
    icon: Globe,
    iconColor: 'text-sky-400',
    actionHighlight: '120 points',
    bravos: 31,
  ...
  },
  {
    ...
    action: 'A dépassé les 13 000 points de progression et continue de pousser le rucher vers son objectif final.',
    icon: Gift,
    iconColor: 'text-emerald-400',
    actionHighlight: '13 000 points',
    bravos: 61,
  ...
  },
  {
    ...
    time: 'Il y a 4 jours',
    action: 'A organisé une collecte locale avec 12 participants.',
    icon: Sparkles,
    iconColor: 'text-amber-400',
      ...
      {event.avatarUrl ? (
        <img
          ...
          className={cn(
            ...
            event.faction && !event.isSystem ? '[box-shadow:0_0_0_1px_rgba(52,199,89,0.25),0_0_8px_2px_rgba(52,199,89,0.5)]' : 'border-border/30',
            event.faction === 'Vie Sauvage' && !event.isSystem && '[box-shadow:0_0_0_1px_rgba(255,184,0,0.25),0_0_8px_2px_rgba(255,184,0,0.5)]',
            event.faction === 'Gardiens des mers' && !event.isSystem && '[box-shadow:0_0_0_1px_rgba(0,199,255,0.25),0_0_8px_2px_rgba(0,199,255,0.5)]',
          )}
        />
        ...
        <div
          className={cn(
            ...
            event.faction === 'Terres & Forêts' && !event.isSystem && !event.isCurrentUser ? '[box-shadow:0_0_0_1px_rgba(52,199,89,0.25),0_0_8px_2px_rgba(52,199,89,0.5)]' : 'border-border/30',
            event.faction === 'Vie Sauvage' && !event.isSystem && !event.isCurrentUser ? '[box-shadow:0_0_0_1px_rgba(255,184,0,0.25),0_0_8px_2px_rgba(255,184,0,0.5)]' : 'border-border/30',
            event.faction === 'Gardiens des mers' && !event.isSystem && !event.isCurrentUser ? '[box-shadow:0_0_0_1px_rgba(0,199,255,0.25),0_0_8px_2px_rgba(0,199,255,0.5)]' : 'border-border/30',
          )}
        >
          {event.name[0]}
        </div>
