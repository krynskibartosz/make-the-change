...
export default async function ImpactRewardPage() {
  ...
  const ilangaProducts = getMockProducts().filter((p) => p.producer_id === MOCK_PRODUCER_ILANGA_ID)
      ...
      <div className="flex flex-col">
          ...
          <div className="flex flex-col items-center text-center">
            {initialFaction ? (
              <div className="relative mb-4 flex h-24 w-24 items-center justify-center">
                <div
                  className={`absolute inset-0 rounded-full blur-2xl opacity-40 ${activeTheme.accentBg}`}
                />
                <img
                  src={mascotSrc}
                  alt="Mascotte faction"
            ...
            <p
              className={`text-[10px] font-bold uppercase tracking-[0.2em] ${activeTheme.accentTextSoft}`}
            >
              AVANTAGE DU MOIS
            </p>
            <h2 className="mt-1 text-2xl font-black text-white">Le D�fi Ilanga Nature</h2>
            <p className="mt-3 max-w-xs text-sm leading-relaxed text-white/60">
              Atteignons ensemble les 100�% en cumulant des contributions�! En remerciement de cet
              effort commun, notre partenaire{' '}
              <span className="font-semibold text-white">Ilanga Nature</span> d�bloquera des
              avantages exclusifs pour toute la communaut�.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1 border-b border-white/5 pb-4">
                ...
                <p className="text-sm text-white/50">
                  D�bloqu� pour toute la communaut� si l'objectif est atteint.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex-1 pb-2">
                ...
                <p className="text-sm text-white/50">
                  La faction ayant le plus progress� obtiendra un �clat cosm�tique exclusif.
                </p>
              </div>
            </div>
          </div>
                ...
                {ilangaProducts.map((product) => (
                  ...
                  >
                    ...
                    <div className="mt-3 flex flex-col gap-0.5">
                      ...
                      <span className="text-[10px] text-white/30">Achat partenaire en euros</span>
                    </div>
                  </Link>
                ))}
        ...
        <div className="sticky bottom-0 z-20 w-full border-t border-white/5 bg-[#0B0F15]/80 p-5 backdrop-blur-xl sm:px-6">
          {!isConnected ? (
            ...
            >
              Contribuer � l'objectif{' '}
              <Sprout className="inline h-[1.2em] w-[1.2em] align-text-bottom" />
            </Link>
          ) : !initialFaction ? (
            <Link
            ...
            >
              D�bloquer les avantages{' '}
              <Crown className="inline h-[1.2em] w-[1.2em] align-text-bottom" />
            </Link>
          ) : isGoalReached ? (
            <Link
              href="/impact"
