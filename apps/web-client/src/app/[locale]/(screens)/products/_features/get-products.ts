...
export const getProducts = unstable_cache(_getProducts, ['products-list'], {
  revalidate: 3600,
  tags: ['products-list'],
})
...
export const getProductStaticResources = unstable_cache(_getProductStaticResources, ['products-static'], {
  revalidate: 86400,
