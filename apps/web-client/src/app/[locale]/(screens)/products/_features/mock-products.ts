...
const MOCK_PRODUCTS: MockProductSeed[] = [
  ...
  // ── Produits V2 Ilanga Nature (9 miels + vanilles + épices + confitures) ──
  {
    id: 'ilanga-miel-litchi',
    slug: 'miel-litchi-ilanga-nature',
    name_default: 'Miel de Litchi',
    name_i18n: { fr: 'Miel de Litchi', en: 'Litchi Honey' },
    short_description_default: 'Miel floral et fruité des côtes est de Madagascar',
    short_description_i18n: { fr: 'Miel floral et fruité des côtes est de Madagascar', en: 'Floral and fruity honey from the east coast of Madagascar' },
    description_default: 'Un miel exceptionnel produit à partir des fleurs de litchi (Litchi chinensis) cultivées sur la côte est de Madagascar, dans la région de Manakara. Saveur unique et délicate.',
    producer_id: MOCK_PRODUCER_ILANGA_ID,
    category_id: 'mock-category-honey',
    images: ['/images/producteurs/illanga-nature/produits-miels-trio.jpg'],
    price_points: 1200,
    ...
    producer: {
      ...
      slug: MOCK_PRODUCER_ILANGA_SLUG,
      name_default: 'Ilanga Nature',
      description_default: 'Fondée en 2017, Ilanga Nature structure une filière apicole locale avec mielleries mobiles, formation des apiculteurs et certification biologique Ecocert.',
      images: [],
      address_city: 'Mariembourg',
      address_country_code: 'Belgique',
      contact_website: 'https://www.ilanga-nature.com',
    },
    category: { id: 'mock-category-honey', name_default: 'Miel' },
  },
  {
    id: 'ilanga-miel-niaouli',
    slug: 'miel-niaouli-ilanga-nature',
    name_default: 'Miel de Niaouli',
    name_i18n: { fr: 'Miel de Niaouli', en: 'Niaouli Honey' },
    short_description_default: 'Miel aromatique des savanes malgaches',
    short_description_i18n: { fr: 'Miel aromatique des savanes malgaches', en: 'Aromatic honey from Malagasy savannas' },
    description_default: 'Miel puissant et thérapeutique issu des fleurs de niaouli (Melaleuca quinquenervia), présent dans les savanes et zones humides de Madagascar.',
    producer_id: MOCK_PRODUCER_ILANGA_ID,
    category_id: 'mock-category-honey',
    images: ['/images/producteurs/illanga-nature/produits-miels-trio.jpg'],
    price_points: 1100,
  ...
  {
    id: 'ilanga-miel-cactus',
    slug: 'miel-cactus-ilanga-nature',
    name_default: 'Miel de Cactus',
    name_i18n: { fr: 'Miel de Cactus', en: 'Cactus Honey' },
    short_description_default: 'Miel rare du Grand Sud malgache',
    short_description_i18n: { fr: 'Miel rare du Grand Sud malgache', en: 'Rare honey from the Great South of Madagascar' },
    description_default: 'Miel unique associé à la flore succulente du Grand Sud de Madagascar, région de Fort-Dauphin. Saveur complexe et terreuse.',
    producer_id: MOCK_PRODUCER_ILANGA_ID,
    category_id: 'mock-category-honey',
    images: ['/images/producteurs/illanga-nature/produits-miels-trio.jpg'],
    price_points: 1300,
  ...
  {
    id: 'ilanga-vanille-manakara',
    slug: 'vanille-manakara-ilanga-nature',
    name_default: 'Vanille Bourbon de Manakara',
    name_i18n: { fr: 'Vanille Bourbon de Manakara', en: 'Manakara Bourbon Vanilla' },
    short_description_default: 'Vanille premium de la côte est malgache',
    short_description_i18n: { fr: 'Vanille premium de la côte est malgache', en: 'Premium vanilla from the east coast of Madagascar' },
    description_default: 'Vanille Bourbon (Vanilla planifolia) cultivée dans la région de Manakara, sur la côte est de Madagascar. Saveur riche et aromatique.',
    producer_id: MOCK_PRODUCER_ILANGA_ID,
    category_id: 'mock-category-vanilla',
    images: ['/images/producteurs/illanga-nature/produits-vanilles-collection.jpg'],
    price_points: 2500,
    created_at: '2026-05-17T08:00:00.000Z',
    updated_at: '2026-05-17T08:00:00.000Z',
    producer: {
    ...
    category: { id: 'mock-category-vanilla', name_default: 'Vanille' },
  },
  {
