...
const MOCK_PRODUCTS: MockProductSeed[] = [
  ...
  },
  {
    ...
    images: [
      HABEEBEE_PATHS.media.shopBeeSurprised,
      'https://images.unsplash.com/photo-1607006344380-b6775a0824a7?auto=format&fit=crop&q=80&w=1200',
    ],
    isTemporaryVisual: true,
    producer: HABEEBEE,
    category: CATEGORIES.bundle,
  ...
  },
  {
    ...
    images: [
      ILANGA_PATHS.media.shopMielEucalyptus,
      'https://images.unsplash.com/photo-1587049352846-4a222e784d38?auto=format&fit=crop&q=80&w=1200',
    ],
    isTemporaryVisual: true,
    producer: ILANGA,
  ...
  },
  {
    ...
    images: [
      ILANGA_PATHS.media.shopMielLitchi,
      'https://images.unsplash.com/photo-1559181567-c3190ca9be3d?auto=format&fit=crop&q=80&w=1200',
    ],
    isTemporaryVisual: true,
    producer: ILANGA,
    category: CATEGORIES.honey,
  ...
  },
  {
    ...
    images: [
      HABEEBEE_PATHS.media.shopSavonDoux,
  ...
  },
  {
    ...
    images: [
      HABEEBEE_PATHS.media.shopShampoingSolide,
      'https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?auto=format&fit=crop&q=80&w=1200',
    ],
    isTemporaryVisual: true,
    producer: HABEEBEE,
    category: CATEGORIES.care,
