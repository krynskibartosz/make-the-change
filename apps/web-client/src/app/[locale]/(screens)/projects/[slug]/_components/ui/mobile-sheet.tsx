      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-x-0 bottom-0 z-40 mx-auto max-w-xl overflow-hidden rounded-t-3xl border border-white/10 bg-[#08080F]/95 shadow-[0_-20px_80px_rgba(0,0,0,0.6)] backdrop-blur-xl"
          >
