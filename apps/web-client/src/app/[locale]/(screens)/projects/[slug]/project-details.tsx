...
import { EcosystemCard } from '@/app/[locale]/(screens)/profile/contributions/_components/ecosystem-card'
import { getEcosystemById, getPropertiesByProjectId } from '@/app/[locale]/(screens)/projects/_actions/ecosystem.actions'
import { buildPublicAppUrl } from '@/lib/public-url'
import { ProjectCoverHero } from './_components/layout/project-cover-hero'
import { ProjectMainContent } from './_components/layout/project-main-content'
import { ProjectSidebar } from './_components/layout/project-sidebar'
