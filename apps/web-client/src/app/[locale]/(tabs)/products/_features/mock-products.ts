...
const MOCK_PRODUCTS: MockProductSeed[] = [
  {
    ...
    images: ['/images/products/miel eucalytpus ilanga-v2.png'],
  ...
  },
  {
    ...
    fulfillment_method: 'ship',
    image_url: '/images/products/miel-mnakara-v2.png',
    images: ['/images/products/miel-mnakara-v2.png'],
  ...
  },
  {
    ...
    fulfillment_method: 'ship',
    image_url: '/images/products/Savon Doux Habeebee-v2.png',
    images: ['/images/products/Savon Doux Habeebee-v2.png'],
  ...
  },
  {
    ...
    price_eur_equivalent: 5.5,
    fulfillment_method: 'ship',
    image_url: '/images/products/Shampoing solide Habeebee-v2.png',
    images: ['/images/products/Shampoing solide Habeebee-v2.png'],
  ...
  },
  {
    ...
    fulfillment_method: 'ship',
    image_url: '/images/products/Huile Leccino-v2.png',
    images: ['/images/products/Huile Leccino-v2.png'],
  ...
  },
  {
    ...
    fulfillment_method: 'ship',
    image_url: '/images/products/Huile Frantoio-v2.png',
    images: ['/images/products/Huile Frantoio-v2.png'],
