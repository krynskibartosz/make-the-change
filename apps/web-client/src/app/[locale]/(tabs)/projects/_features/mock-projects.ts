...
const antsirabeSpecies: ProjectSpecies[] = [
  {
    ...
    icon: '/images/dioramas/transparent/abeille-noire.png',
    rarity: 7,
    status: 'DD',
...
const sardiniaSpecies: ProjectSpecies[] = [
  {
    ...
    icon: '/images/dioramas/transparent/abeille-noire.png', // À remplacer par image olivier quand disponible
    rarity: 6,
    status: 'LC',
...
const coralSpecies: ProjectSpecies[] = [
  {
    ...
    icon: '/images/dioramas/transparent/acropora-corail-corne-de-cerf.png',
    rarity: 9,
    status: 'CR',
  ...
  },
  {
    ...
    icon: '/images/dioramas/transparent/poisson-clown.png',
    rarity: 6,
    status: 'VU',
  ...
  },
  {
    ...
    icon: '/images/dioramas/transparent/tortue-verte.png',
    rarity: 8,
    status: 'EN',
...
const coralProducts: ProducerProduct[] = [
  {
    ...
    category: 'Corail',
    impactPercentage: 25,
    image_url: '/images/projects/coral-karimunjawa.png',
  },
  {
...
export const MOCK_PROJECTS: MockProjectSeed[] = [
  ...
  },
  {
    ...
    target_budget: 15600,
    hero_image_url: '/images/projects/miellerie-manakara.png',
    images: ['/images/projects/miellerie-manakara.png'],
    unit_price_eur: 390,
    unit_label: 'ruche',
  ...
  },
  {
    ...
    target_budget: 16500,
    hero_image_url: '/images/projects/miellerie-mobile.png',
    images: ['/images/projects/miellerie-mobile.png'],
  ...
  },
  {
    ...
    target_budget: 25000,
    hero_image_url: '/images/projects/oliveraie-sardaigne.png',
  ...
  },
  {
    ...
    target_budget: 15000,
    hero_image_url: '/images/projects/coral-karimunjawa.png',
  ...
  },
  {
    ...
    current_funding: 8500,
    target_budget: 20000,
    hero_image_url: '/images/projects/habeebee.png',
