...
const antsirabeProducts: ProducerProduct[] = [
  {
    ...
    type: 'impact',
    format: 'bocal',
    image_url: '/images/products/miel eucalytpus ilanga-v2.png',
  },
  {
...
const sardiniaSpecies: ProjectSpecies[] = [
  {
    ...
    icon: '/images/diaromas/abeille noire.png', // À remplacer par image olivier quand disponible
    rarity: 6,
    status: 'LC',
...
const habeebeeSpecies: ProjectSpecies[] = [
  {
    ...
    icon: '/images/diaromas/Bourdon terrestre.png',
    rarity: 5,
    status: 'NT',
  ...
  },
  {
    ...
    icon: '/images/diaromas/Osmie rousse.png',
    rarity: 5,
    status: 'NT',
    role: 'Pollinisateur cle',
  },
  {
    ...
    icon: '/images/diaromas/Mégachile.png',
    rarity: 5,
    status: 'NT',
    role: 'Pollinisateur cle',
  },
  {
    ...
    icon: '/images/diaromas/Syrphe ceinturé.png',
    rarity: 4,
    status: 'LC',
    role: 'Pollinisateur',
  },
  {
    ...
    icon: '/images/diaromas/Papillon citron.png',
    rarity: 4,
    status: 'LC',
    role: 'Pollinisateur',
  },
  {
    ...
    icon: '/images/diaromas/Paon-du-jour.png',
    rarity: 4,
    status: 'LC',
    role: 'Pollinisateur',
  },
  {
    ...
    icon: '/images/diaromas/Coccinelle.png',
    rarity: 3,
    status: 'LC',
    role: 'Auxiliaire',
  },
  {
    ...
    icon: '/images/diaromas/Hérisson européen.png',
    rarity: 5,
    status: 'LC',
    role: 'Faune associee',
  },
...
const coralSpecies: ProjectSpecies[] = [
  {
    ...
    icon: '/images/diaromas/Acropora  Corail corne de cerf.png',
    rarity: 9,
    status: 'CR',
...
const coralProducts: ProducerProduct[] = [
  {
    ...
    category: 'Corail',
    impactPercentage: 25,
    image_url: '/images/projects/coral-karimunjawa-v2.png',
  },
  {
...
export const MOCK_PROJECTS: MockProjectSeed[] = [
  ...
  },
  {
    ...
    target_budget: 15600,
    hero_image_url: '/images/projects/miellerie-manakara-v2.png',
    images: ['/images/projects/miellerie-manakara-v2.png'],
    unit_price_eur: 390,
    unit_label: 'ruche',
  ...
  },
  {
    ...
    target_budget: 25000,
    hero_image_url: '/images/projects/oliveraie-sardaigne-v2.png',
    images: ['/images/projects/oliveraie-sardaigne-v2.png'],
    unit_price_eur: 150,
    unit_label: 'olivier',
    updated_at: '2026-04-19T10:00:00.000Z',
    producer: {
  ...
  },
  {
    ...
    target_budget: 15000,
    hero_image_url: '/images/projects/coral-karimunjawa-v2.png',
    images: ['/images/projects/coral-karimunjawa-v2.png'],
    unit_price_eur: 30,
    unit_label: 'corail',
    updated_at: '2026-04-19T10:00:00.000Z',
    producer: {
  ...
  },
  {
    ...
    current_funding: 8500,
    target_budget: 20000,
    hero_image_url: '/images/projects/habeebee-v2.png',
    images: ['/images/projects/habeebee-v2.png'],
    unit_price_eur: 1300,
    unit_label: 'ruche',
