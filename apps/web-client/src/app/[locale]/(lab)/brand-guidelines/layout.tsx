...
import { GuidelinesHero } from '@/app/[locale]/(lab)/brand-guidelines/_features/guidelines-hero'
import { GuidelinesNav } from '@/app/[locale]/(lab)/brand-guidelines/_features/guidelines-nav'
