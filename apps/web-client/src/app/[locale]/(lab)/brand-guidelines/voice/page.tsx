...
import { GuidelinesContentShell } from '@/app/[locale]/(lab)/brand-guidelines/_features/guidelines-content-shell'
import {
  getBrandGuidelineMetadata,
  resolveGuidelineLocale,
} from '@/app/[locale]/(lab)/brand-guidelines/_features/metadata'
