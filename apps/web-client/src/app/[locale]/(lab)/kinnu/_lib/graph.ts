...
export const KINNU_WORLDS: KinnuWorld[] = [
  {
    ...
    nodes: [
      ...
      { id: 'abeille-noire-manakara', name: 'Abeille noire', type: 'fauna', trophicLevel: 2, lane: 16, summary: 'Pollinisateur clé de la forêt humide malgache. Directement soutenue par le Rucher de Manakara.', requires: ['orchidee-manakara'], speciesId: MOCK_SPECIES_BLACK_BEE_ID, imageUrl: '/images/dioramas/abeilles-pollinisatrices.png' },
      { id: 'charancon-manakara', name: 'Charançon girafe', type: 'fauna', trophicLevel: 2, lane: 52, summary: 'Insecte spectaculaire. Le mâle a un "cou" 3× plus long que la femelle pour construire ses nids de feuilles.', requires: ['orchidee-manakara'], speciesId: MOCK_SPECIES_WEEVIL_ID, imageUrl: '/images/dioramas/charancon-girafe.png' },
      { id: 'cameleon-manakara', name: 'Caméléon de Parson', type: 'fauna', trophicLevel: 3, lane: 38, summary: "L'un des plus grands caméléons du monde. Prédateur de canopée — sa présence indique une forêt intacte.", requires: ['charancon-manakara'], speciesId: MOCK_SPECIES_CHAMELEON_ID, imageUrl: '/images/dioramas/cameleon-de-parson.png' },
      ...
      { id: 'vari-manakara', name: 'Vari noir et blanc', type: 'fauna', trophicLevel: 4, lane: 52, summary: 'Grand lémur frugivore en danger critique. Sa présence dans la canopée haute révèle une forêt intacte.', requires: ['cameleon-manakara'], speciesId: MOCK_SPECIES_VARI_ID, imageUrl: '/images/dioramas/vari-noir-et-blanc.png' },
    ],
    edges: [
  ...
  },
  {
    ...
    nodes: [
      { id: 'acropora-karimunjawa', name: 'Acropora', type: 'fauna', trophicLevel: 1, lane: 48, summary: 'Corail constructeur : forme la structure du récif. Sans lui, pas d\'habitat pour les autres espèces marines.', requires: [], focal: true, speciesId: MOCK_SPECIES_ACROPORA_ID, imageUrl: '/images/dioramas/acropora-corail-corne-de-cerf.png' },
      ...
      { id: 'poisson-clown-karimunjawa', name: 'Poisson clown', type: 'fauna', trophicLevel: 2, lane: 24, summary: 'Vit en symbiose avec les anémones. Dépend de la structure corallienne pour son habitat et sa survie.', requires: ['acropora-karimunjawa'], speciesId: MOCK_SPECIES_CLOWNFISH_ID, imageUrl: '/images/dioramas/poisson-clown.png' },
      ...
      { id: 'demoiselle-karimunjawa', name: 'Demoiselle bleue', type: 'fauna', trophicLevel: 3, lane: 34, summary: 'Petit poisson territorial qui protège son patch d\'algues, entretenant indirectement la santé du corail.', requires: ['poisson-clown-karimunjawa'], speciesId: MOCK_SPECIES_BLUE_DEMOISELLE_ID, imageUrl: '/images/dioramas/demoiselle-bleue.png' },
      { id: 'tortue-karimunjawa', name: 'Tortue verte', type: 'fauna', trophicLevel: 3, lane: 72, summary: 'Grande espèce ambassadrice. Broute les herbiers et maintient l\'équilibre de la nurserie récifale.', requires: ['nurserie-recif'], speciesId: MOCK_SPECIES_GREEN_TURTLE_ID, imageUrl: '/images/dioramas/tortue-verte.png' },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'bourdon-belgique', name: 'Bourdon terrestre', type: 'fauna', trophicLevel: 1, lane: 24, summary: 'Pollinisateur robuste, actif même par temps frais. Essentiel pour de nombreuses cultures locales.', requires: ['haie-belgique'], speciesId: MOCK_SPECIES_BUMBLEBEE_ID, imageUrl: '/images/dioramas/bourdon-terrestre.png' },
      { id: 'osmie-belgique', name: 'Osmie rousse', type: 'fauna', trophicLevel: 1, lane: 52, summary: 'Abeille solitaire 300× plus efficace que l\'abeille domestique. Dépend de tiges creuses pour nidifier.', requires: ['haie-belgique'], speciesId: MOCK_SPECIES_OSMIA_ID, imageUrl: '/images/dioramas/osmie-rousse.png' },
      { id: 'syrphe-belgique', name: 'Syrphe ceinturé', type: 'fauna', trophicLevel: 1, lane: 76, summary: 'Adulte pollinisateur, larve auxiliaire contre les pucerons. Imite les guêpes pour se protéger.', requires: ['haie-belgique'], speciesId: MOCK_SPECIES_SYRPHID_ID, imageUrl: '/images/dioramas/syrphe-ceinture.png' },
      { id: 'megachile-belgique', name: 'Mégachile', type: 'fauna', trophicLevel: 2, lane: 34, summary: 'Abeille coupeuse de feuilles : découpe des rondelles précises pour construire ses alvéoles.', requires: ['bourdon-belgique'], speciesId: MOCK_SPECIES_MEGACHILE_ID, imageUrl: '/images/dioramas/megachile.png' },
      { id: 'coccinelle-belgique', name: 'Coccinelle', type: 'fauna', trophicLevel: 2, lane: 64, summary: 'Une coccinelle consomme jusqu\'à 150 pucerons par jour. Alliée naturelle de tous les pollinisateurs.', requires: ['syrphe-belgique'], speciesId: MOCK_SPECIES_LADYBUG_ID, imageUrl: '/images/dioramas/coccinelle.png' },
