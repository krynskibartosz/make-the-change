...
export function ActivityList({ userInvestments, userOrders, totalInvested, totalPoints }: ActivityListProps) {
  ...
  return (
    <>
      ...
      <div className="relative z-10 mx-6 mb-6 overflow-x-hidden rounded-3xl border border-white/5 bg-gradient-to-br from-[#1A1F26] to-[#0B0F15] p-6 shadow-lg flex justify-between items-center">
