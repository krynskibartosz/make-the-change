      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-x-0 bottom-0 z-[210] mx-auto max-w-xl overflow-hidden rounded-t-3xl border border-white/[0.08] bg-[#0B0F15]/90 shadow-[0_-12px_48px_rgba(0,0,0,0.5)] backdrop-blur-xl"
          >
