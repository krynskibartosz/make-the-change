  ...
  return (
    <MarketingSection title={title} description={description} size="lg" className="pb-20" variant={variant}>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 h-auto lg:h-[600px]">
        <Link
          href="/projects"
          className="lg:col-span-7 relative group overflow-hidden rounded-[2.5rem] border shadow-2xl cursor-pointer block"
        >
          <img
        ...
        <div className="lg:col-span-5 grid grid-rows-2 gap-6">
          <div className="h-[300px] lg:h-full relative group rounded-[2.5rem] border shadow-xl overflow-hidden">
          ...
          <div className="h-[300px] lg:h-full relative group rounded-[2.5rem] border shadow-xl bg-card overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center space-y-4">
              ...
              <Button
                variant="outline"
                size="sm"
                className="rounded-xl border-border text-foreground hover:bg-accent pointer-events-none"
              >
                {community.cta}
              </Button>
