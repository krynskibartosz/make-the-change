...
export const HABEEBEE_PATHS = {
  ...
  media: {
    ...
    story2Cycle: `${MD}/story-2-cycle-habeebeeculture.png`,
    story3Ruche: `${MD}/story-3-ruche.jpg`,
    story4TedyArtisan: `${MD}/story-4-tedy-artisan.jpg`,
    story4V2: `${MD}/story-4-v2.png`,
    story5TedyFabrication: `${MD}/story-5-tedy-fabrication.jpg`,
