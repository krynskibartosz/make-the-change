...
const MOCK_ACADEMY_SYLLABUS: AcademySyllabus = {
  ...
  chapters: [
    ...
    // ── CHAPITRE 3 : verrouillé ───────────────────────────────
    {
      ...
      status: "locked",
      units: [
        { id: '3.1', title: 'Le Cycle du Carbone',     status: 'locked', reward: '25 Graines', mascotte: 'ondine',              description: 'Le carbone circule partout — atmosphère, océan, sol. Comprendre ce cycle, c\'est comprendre le climat.' },
        { id: '3.2', title: 'L\'Azote, Chef Invisible', status: 'locked', reward: '25 Graines', mascotte: 'sylva',               description: 'Sans azote, pas de protéines, pas de vie. Découvre comment les plantes s\'en emparent.' },
        { id: '3.3', title: 'L\'Eau qui Voyage',        status: 'locked', reward: '30 Graines', mascotte: 'abeille-transparente', description: 'Évaporation, précipitations, filtration : le voyage infini de chaque goutte d\'eau.' },
        { id: '3.4', title: 'Les Poumons du Monde',     status: 'locked', reward: '35 Graines', mascotte: 'ondine',              description: 'Les forêts régulent le climat planétaire. Mais pour combien de temps encore ?' },
      ],
    },
    ...
    // ── CHAPITRE 4 : verrouillé ───────────────────────────────
    {
      ...
      status: "locked",
      units: [
        { id: '4.1', title: 'Les Abysses', status: 'locked', reward: '30 Graines', mascotte: 'ondine', description: 'Un monde sans lumière, sans chaleur, pourtant fourmillant de vie.' },
        { id: '4.2', title: 'La Canopée', status: 'locked', reward: '30 Graines', mascotte: 'sylva',  description: 'À 50 mètres du sol, une jungle dans la jungle — les secrets de la canopée.' },
        { id: '4.3', title: 'La Toundra', status: 'locked', reward: '35 Graines', mascotte: 'abeille-transparente', description: 'Où survivre semble impossible. Pourtant, la vie a trouvé un moyen.' },
        { id: '4.4', title: 'Les Récifs Coralliens', status: 'locked', reward: '40 Graines', mascotte: 'ondine', description: 'Le paradis sous-marin qui nourrit 25 % de la vie marine — et qui disparaît.' },
      ],
    },
  ],
}
