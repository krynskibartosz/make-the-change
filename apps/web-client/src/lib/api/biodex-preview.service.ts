...
const DEFAULT_SPECIES_IMAGE = '/images/dioramas/transparent/abeille-noire.png' // Image générique de fallback
...
const FALLBACK_SPECIES: FallbackSpecies[] = [
  ...
  },
  {
    ...
    isUnlocked: false,
    image_url: '/images/dioramas/transparent/eucalyptus.png',
  },
  {
