# Make the Change - Business, RSE et Modele Economique

> Source pour les Gems Business, Produit et RSE.
> Perimetre: vision cible de `apps/web-client`.
...
| Contenus premium            | Futur           | contenus avances, pas Academy de base      |
| Achat direct de Graines     | deconseille     | risque de pay-to-win symbolique            |
...
Le bonus Graines doit rester modere pour ne pas transformer la progression en achat.

## 6. Marketplace Partenaire
...
- generes par soutien producteur;
- pas generes par don pur;
- pas donnes gratuitement chaque mois par abonnement;
- peuvent expirer plus tard si le modele le demande, mais cela reste a decider.
...
- gagnees par dons purs, Academy, missions et petits bonus symboliques;
- depensees pour contenus BioDex, niveaux, Academy ou elements de progression;
- achat direct de Graines deconseille.

## 9. Abonnement Ambassadeur

**Cible validee**: un seul abonnement.

Promesse principale:

> Soutenir la biodiversite chaque mois.

Promesse secondaire:

> Acceder a une experience plus riche pour suivre, apprendre et agir.

### 9.1 Structure Recommandee

- paiement mensuel;
- budget de soutien mensuel;
- allocation manuelle par l'utilisateur ou automatique selon preferences/faction;
- avantages premium;
- rapports enrichis;
- badge/statut Ambassadeur.
...
### 9.3 Avantages Possibles

- contenus Academy avances;
- rapports d'impact personnels;
- acces prioritaire a certains projets ou produits;
- avantages boutique;
- badge Ambassadeur;
- campagnes exclusives;
- reduction livraison si viable.

## 10. RSE / B2B

La RSE doit etre un pilier strategique.
...
- Hypothese forte;
- pas forcement V1 B2C;
- a cadrer avec les premiers partenaires.

### 10.3 Experience Salaries

Recommandation:

- meme app coeur que le B2C;
- couche entreprise legere.

Exemples:

- budget sponsorise;
- badge "via votre entreprise";
- challenges d'equipe;
- projets recommandes par l'entreprise;
- rapport collectif.

Ne pas creer une app separee au debut.

## 11. Contenus Premium

Le contenu premium ne doit pas signifier "payer pour comprendre la biodiversite de base".

Contenus premium acceptables:

- parcours Academy avances;
- masterclass biodiversite;
- rapports personnalises;
- analyses d'impact;
- contenus experts partenaires;
- mode famille/ecole;
- evenements ou campagnes speciales.

Academy de base:

- gratuite;
- utile a la mission;
- importante pour retention et credibilite.
...
| trop de plans abonnement | complexite            | abonnement unique Ambassadeur       |

## 13. Questions A Decider
