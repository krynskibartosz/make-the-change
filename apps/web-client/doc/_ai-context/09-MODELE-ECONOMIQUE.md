...
## Promesse business initiale (validée)

La promesse business initiale est de tester d'abord la conversion autour du **don pur** et du **soutien producteur**. Ces deux gestes sont le cœur économique du produit en V1.

Tout le reste (boutique, abonnement, RSE, marketplace) est secondaire ou expérimental et ne doit pas diluer cette priorité.

---

## Sources de revenus et leur statut
...
| **Sponsoring / partenariats** | Marques ou producteurs partenaires | Hypothèse |

---

## Ce qui est validé

- La séparation don pur / soutien producteur / achat produit est officielle.
- La boutique est un prolongement, pas le cœur moral du produit.
- Les récompenses ne doivent jamais devenir plus importantes que le projet soutenu.
- L'abonnement Ambassadeur ne doit pas être présenté comme lancé ou définitif.
- La RSE n'est pas une offre mature en V1.
...
## Wording business selon le geste

| Geste | Ce qu'on peut dire | Ce qu'on ne doit pas dire |
|---|---|---|
...
## Métriques à suivre pour valider le modèle

- Compréhension de la promesse en moins de 30 secondes.
...
- Signaux d'intérêt pour l'abonnement Ambassadeur.
- Nombre de partenaires producteurs intéressés.
- Nombre de prospects RSE intéressés.

---

## Ordre de priorité pour tester le business
