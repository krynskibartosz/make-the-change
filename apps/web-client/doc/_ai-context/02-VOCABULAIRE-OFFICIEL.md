# 02 — Vocabulaire officiel de Make the Change
...
| **Mission** | Impulsion courte et guidée donnant une direction quotidienne. Peut renvoyer vers Academy, projets, BioDex. Peut donner des Graines. Ne crée pas d'impact direct. |
...
| **Reçu de contribution** | Trace d'un don ou soutien. Ne constitue pas un reçu fiscal sans validation légale. |

---

## Termes à éviter absolument dans les textes utilisateur

| Terme à éviter | Pourquoi | Alternative recommandée |
|---|---|---|
...
| CO2 capturé | Métrique sensible sans méthode | Estimation CO2 selon méthode documentée |
| Espèces protégées | Trop fort sans preuve | Espèces liées au projet |
| Compensation carbone | Risque de greenwashing | Contribution positive, soutien à un projet |
| Reçu fiscal | Risque légal si statut non validé | Reçu de contribution |
| Impact mesuré | Réservé à un niveau de preuve supérieur | Impact estimé, suivi en cours |
| Quest | Terme technique interne, pas wording final | Mission ou Défi selon le contexte |
| Artisans Locaux | Faction dépréciée et retirée | Vie Sauvage, Terres & Forêts, Gardiens des mers |
...
Environ X abeilles soutenues selon l'hypothèse du projet.
Ce projet vise à restaurer des zones de récif corallien.
...
## Formulations à vérifier avant usage public
