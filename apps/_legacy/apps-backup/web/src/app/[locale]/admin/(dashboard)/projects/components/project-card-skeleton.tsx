...
/**
 * Project Card Skeleton - Grid View
  ...
  <DataCard className="!overflow-visible">
    ...
    <DataCard.Content className="relative z-10">
      ...
      <div className="pt-16 space-y-3">
        ...
        <div className={`h-4 w-full rounded-md bg-muted/30 ${shimmerClasses}`} />
        <div className={`h-4 w-2/3 rounded-md bg-muted/30 ${shimmerClasses}`} />
      </div>
    ...
    <DataCard.Footer>
      ...
      <div className="flex w-full items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          {/* Funding controls */}
          <div className="bg-background dark:bg-card border-border dark:border-border inline-flex items-center overflow-hidden rounded-xl border shadow-sm">
            <div className={`h-10 w-10 ${shimmerClasses}`} />
            <div className={`h-10 w-16 border-x ${shimmerClasses}`} />
            <div className={`h-10 w-10 ${shimmerClasses}`} />
          </div>
          {/* Featured button */}
...
/**
 * Project List Skeleton - List View
 */
