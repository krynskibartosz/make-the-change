...
import { Info, Sparkles, Hash, Folder, Tag, ShieldCheck, Crown } from 'lucide-react';
...
import { WithAutoSaveProps } from './with-auto-save';
...
export const EssentialInfoSection: FC<WithAutoSaveProps> = ({ autoSave }) => {
  ...
  return (
    <DetailView.Section icon={Info} title={t('admin.products.edit.sections.essential', { defaultValue: 'Informations essentielles' })}>
      <DetailView.Field
        ...
        <InputV2
          ...
          placeholder={
            nameField.isBaseLang
              ? t('admin.products.edit.placeholders.name', { defaultValue: 'Ex: Miel de Madagascar' })
        ...
        <Controller
          ...
          render={({ field }) => (
            <InputV2
              ...
              required
              value={field.value ?? ''}
              placeholder={t('admin.products.edit.placeholders.slug', { defaultValue: 'ex-miel-de-madagascar' })}
              onChange={event => {
