...
import { DollarSign, Star, Coins, Package, Truck, Factory, Eye, Sparkles } from 'lucide-react';
...
export const PricingStatusSection: FC<WithAutoSaveProps> = ({ autoSave }) => {
  ...
  return (
    <DetailView.Section icon={DollarSign} title={t('admin.products.edit.sections.pricing', { defaultValue: 'Prix et statut' })}>
      <DetailView.Field
      ...
      <DetailView.Field
        label={t('admin.products.edit.fields.price_eur_equivalent', { defaultValue: 'Équivalent EUR (optionnel)' })}
      ...
      <DetailView.Field
        label={t('admin.products.edit.fields.fulfillment_method', { defaultValue: 'Méthode de livraison' })}
        required
      ...
      {fulfillmentMethod === 'stock' && (
        <DetailView.Field
          label={t('admin.products.edit.fields.stock_quantity', { defaultValue: 'Quantité en stock' })}
