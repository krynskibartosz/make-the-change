    ...
    Views: {
      ...
      investments: {
        Row: {
          ...
          status: 'pending' | 'approved' | 'active' | 'completed' | 'cancelled' | 'defaulted' | null
          updated_at: string | null
          updated_by: string | null
          user_id: string | null
        }
...
export type Database = GeneratedDatabase & {
  commerce: {
    Tables: Pick<
      ...
      'categories' | 'products' | 'orders' | 'order_items' | 'subscriptions'
    >
  ...
  investment: {
    Tables: Pick<GeneratedDatabase['public']['Views'], 'producers' | 'projects' | 'investments'>
    Views: GeneratedDatabase['public']['Views']
    Enums: GeneratedDatabase['public']['Enums']
    CompositeTypes: GeneratedDatabase['public']['CompositeTypes']
  }
...
export type TablesInsert<
  PublicTableNameOrOptions extends keyof PublicSchema['Tables'] | { schema: ValidSchema },
  TableName extends PublicTableNameOrOptions extends { schema: ValidSchema }
    ? keyof Database[PublicTableNameOrOptions['schema']]['Tables']
    : never = never,
> = PublicTableNameOrOptions extends { schema: ValidSchema }
...
export type Enums<
  PublicEnumNameOrOptions extends keyof PublicSchema['Enums'] | { schema: ValidSchema },
