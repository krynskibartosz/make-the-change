...
const GridSkeleton: FC<ProductCardSkeletonProps> = ({ context, className }) => (
...
const ListSkeleton: FC<ProductCardSkeletonProps> = ({ className }) => (
...
export const ProductCardSkeleton: FC<ProductCardSkeletonProps> = ({ view = 'grid', ...props }) => {
  if (view === 'list') {
