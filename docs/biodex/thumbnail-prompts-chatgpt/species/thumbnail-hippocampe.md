# Hippocampe (`Hippocampus bargibanti`)

Target file: `apps/web-client/public/images/species-thumbnails/hippocampe.png`
...
- Seahorse is not lost in camouflage.
- Body curve and curled tail are visible.
- Coral is context, not the main subject.
