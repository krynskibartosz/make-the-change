# Herisson europeen (`Erinaceus europaeus`)

Target file: `apps/web-client/public/images/species-thumbnails/herisson-europeen.png`
...
- Face and spines are readable at 80x80 px.
- Wild/natural, not pet/studio.
