...
Target file: `apps/web-client/public/images/species-thumbnails/bourdon-terrestre.png`
...
- Fuzzy bumblebee reads clearly.
- Buff tail is visible if possible.
- Not confused with honeybee or wasp.
