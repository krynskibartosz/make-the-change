# Abeille mellifere italienne (`Apis mellifera ligustica`)

Target file: `apps/web-client/public/images/species-thumbnails/apis-ligustica.png`
...
- Golden Italian honey bee traits are visible.
- Different from black bee thumbnail.
- Works as a small square icon.
