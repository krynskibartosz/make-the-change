...
Target file: `apps/web-client/public/images/species-thumbnails/poisson-clown.png`
...
- Three white bands are visible.
- One fish dominates the square.
- Natural underwater realism.
