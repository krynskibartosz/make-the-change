# Coccinelle a 7 points (`Coccinella septempunctata`)

Target file: `apps/web-client/public/images/species-thumbnails/coccinelle-7-points.png`
...
- Readable at 80x80 px.
- Seven spots remain visible.
- No second subject competes.
