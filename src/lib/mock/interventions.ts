...
export const mockMaterialMovements: MaterialMovement[] = [
  // --- Existing ones (kept for referential integrity) ---
  {
  ...
  // --- Nouveaux mouvements pour simuler le stock ---
  {
    id: 'mov-protection-achat-masse',
    projectId: SPARRENLAAN_PROJECT_ID,
    materialId: 'mat-protection-sols',
    type: 'purchased',
    quantity: 20,
  ...
  {
    id: 'mov-corniere-achat',
    projectId: SPARRENLAAN_PROJECT_ID,
    materialId: 'mat-corniere-l180',
    type: 'purchased',
    quantity: 10,
    unit: 'piece',
    status: 'bought',
  ...
  {
    id: 'mov-blocs-beton-livraison',
    projectId: SPARRENLAAN_PROJECT_ID,
    materialId: 'mat-blocs-beton',
    type: 'on_site',
    quantity: 500,
    unit: 'piece',
    status: 'on_site',
  ...
  {
    id: 'mov-blocs-terre-cuite-livraison',
    projectId: SPARRENLAAN_PROJECT_ID,
    materialId: 'mat-blocs-terre-cuite',
    type: 'on_site',
    quantity: 1200,
    unit: 'piece',
    status: 'on_site',
  ...
  {
    id: 'mov-beton-c3037-achat',
    projectId: SPARRENLAAN_PROJECT_ID,
    materialId: 'mat-ref-beton-c3037',
    type: 'purchased',
    quantity: 15,
    unit: 'm³',
    status: 'bought',
  ...
  {
    id: 'mov-acier-be500-achat',
    projectId: SPARRENLAAN_PROJECT_ID,
    materialId: 'mat-ref-acier-be500',
    type: 'purchased',
    quantity: 1500,
    unit: 'kg',
    status: 'bought',
  ...
  {
    id: 'mov-mortier-k50-achat',
    projectId: SPARRENLAAN_PROJECT_ID,
    materialId: 'mat-ref-mortier-k50',
    type: 'purchased',
    quantity: 50,
    unit: 'kg',
    status: 'bought',
  ...
  {
    id: 'mov-ancrage-chimique-achat',
    projectId: SPARRENLAAN_PROJECT_ID,
    materialId: 'mat-ref-ancrage-chimique',
    type: 'purchased',
    quantity: 30,
    unit: 'piece',
    status: 'bought',
