...
type EditInterventionFlowProps = Readonly<{
  ...
  initialState: AddInterventionState
}>

export function EditInterventionFlow({ interventionId, initialState }: EditInterventionFlowProps) {
  const router = useRouter()
  const [state, dispatch] = useReducer(reduceAddInterventionState, initialState)
