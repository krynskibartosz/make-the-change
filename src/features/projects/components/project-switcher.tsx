...
import { MapPin, ChevronDown, Building2, CheckCircle2 } from 'lucide-react'
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className={`size-10 rounded-full flex items-center justify-center flex-none ${
                    isActive ? 'bg-primary/20 text-primary' : 'bg-surface-elevated text-muted-foreground'
                  }`}>
                    <Building2 className="size-5" />
                  </div>
                  <div className="flex flex-col">
                    <span className={`font-bold text-base ${isActive ? 'text-primary' : 'text-foreground'}`}>
                      {project.name}
                    </span>
                    <span className="text-xs text-muted-foreground line-clamp-1">{project.address}</span>
                  </div>
                </div>
