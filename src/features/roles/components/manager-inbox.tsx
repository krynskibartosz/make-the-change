...
import { AlertTriangle, CheckCircle2, Clock, MapPin, Mic, ArrowRight } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col gap-6 pb-24 animate-in fade-in slide-in-from-bottom-4">
          ...
          <div className="rounded-xl border border-blue-500/30 bg-blue-500/5 p-4 relative overflow-hidden">
            ...
            <div className="bg-surface rounded-lg p-3 text-sm mb-4 border border-border/50">
              <div className="grid grid-cols-2 gap-y-2">
                ...
                <div className="font-medium text-right flex items-center justify-end gap-1">
                  <Clock className="size-3 text-orange-500" /> <span className="text-orange-500">10h (à confirmer)</span>
                </div>
              </div>
            </div>

            <div className="flex gap-2">
              <Button size="secondary" className="flex-1" variant="primary" leftIcon={<CheckCircle2 className="size-4" />}>
                Valider tout
              </Button>
        ...
        <div>
          ...
          <div className="rounded-xl border border-orange-500/30 bg-orange-500/5 p-4 flex flex-col gap-3">
            <div className="flex justify-between items-start">
              ...
              <span className="bg-orange-500/20 text-orange-500 text-[10px] font-bold px-2 py-0.5 rounded-full">Urgent</span>
            </div>
            <p className="text-xs text-muted-foreground">Signalé par Chris — Zone Extérieur</p>
            <Button variant="secondary" size="compact" className="w-full mt-1">Transformer en tâche</Button>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="rounded-xl border border-border bg-surface p-0 flex flex-col divide-y divide-border">
            <div className="flex items-center justify-between p-3">
              ...
              <Button variant="ghost" size="compact" className="text-primary hover:bg-primary/10">Valider</Button>
            </div>
            <div className="flex items-center justify-between p-3">
              <div className="flex items-center gap-3">
                <div className="size-2 rounded-full bg-blue-500"></div>
      ...
      <section className="mt-4 pt-4 border-t border-border/50">
        <h3 className="text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-3">Actions classiques</h3>
        <div className="grid grid-cols-2 gap-3">
          <Link href="/interventions/new" className="flex items-center justify-between bg-surface border border-border p-3 rounded-xl">
            <span className="text-sm font-medium">Créer Travail</span>
            <ArrowRight className="size-4 text-muted-foreground" />
          </Link>
          <Link href="/ajouter-depense" className="flex items-center justify-between bg-surface border border-border p-3 rounded-xl">
