...
import { ChevronLeft, CheckCircle2, AlertCircle, Calendar, ArrowRight } from 'lucide-react'
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="aspect-square rounded-2xl bg-surface-elevated border border-border overflow-hidden relative group">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-orange-100 to-orange-50 flex items-center justify-center">
                  <span className="text-orange-800/40 font-bold text-lg rotate-[-15deg]">Démolition</span>
                </div>
              </div>
              <div className="aspect-square rounded-2xl bg-surface-elevated border border-border overflow-hidden relative group">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center">
                  <span className="text-blue-800/40 font-bold text-lg rotate-[-15deg]">Gravats</span>
                </div>
              </div>
            </div>
            <Link href="/photos" className="text-sm text-primary font-medium flex items-center gap-1 hover:underline">
          ...
          <section className="flex flex-col gap-4">
            <div className="rounded-2xl border border-orange-500/30 bg-orange-500/5 p-5 flex flex-col gap-4">
              ...
              <p className="text-sm text-muted-foreground">
                Nous avons besoin de votre validation concernant le <strong>Choix technique P1.7</strong> avant de pouvoir couler le béton de la structure.
              </p>
              <Link href="/validations">
                <Button size="secondary" className="w-full bg-orange-500 hover:bg-orange-600 text-white border-transparent">
